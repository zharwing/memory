export function summarizeSessionDeterministically(session) {
...
export function prepareReturnSummaryDeterministically(sessions) {
...
export function classifyDocumentDeterministically(doc) {
    const lowered = `${doc.title}\n${doc.body}`.toLowerCase();
    const type = lowered.includes("decision") || lowered.includes("adr")
