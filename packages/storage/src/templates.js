export function defaultProjectDocument(project, kind) {
...
export function sessionBodyTemplate(args) {
...
export function contextMarkdownHeader(projectName) {
...
function titleFor(kind, projectName) {
    const titles = {
